...
- Use **arrow keys** to move the running mannequin on the main map to the **Enterance of the math building**.
...
12. Move the mannequin using arrow keys to the **math building**.
